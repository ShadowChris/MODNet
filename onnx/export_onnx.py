...
Arguments:
    ...
    --mask-path: path for saving the ONNX model

Example:
    python export_onnx.py \
        --ckpt-path=modnet_photographic_portrait_matting.ckpt \
        --mask-path=modnet_photographic_portrait_matting.onnx
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask-path', type=str, required=True, help='path for saving the ONNX model')
    ...
    torch.onnx.export(
        ...
        dynamic_axes = {'input': {0:'batch_size', 2:'height', 3:'width'}, 'mask': {0: 'batch_size', 2: 'height', 3: 'width'}})
